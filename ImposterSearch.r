...
tokenized.texts = load.corpus.and.parse(files = "all", corpus.lang = "English.all", preserve.case = "FALSE", ngram.size = 2)
...
culled.data <- perform.culling(filtered.data, culling.level = 40)
